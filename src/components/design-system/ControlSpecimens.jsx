    ...
    >
      ...
      >
        <div className="v2-button-row">
          ...
          <button className="v2-button v2-button--secondary" type="button">
            Review changes
          </button>
          <button className="v2-button v2-button--danger" type="button">
            <Trash2 aria-hidden="true" size={18} />
            Delete draft
          </button>
          <button className="v2-button v2-button--icon" type="button" aria-label="More actions">
            <MoreHorizontal aria-hidden="true" size={20} />
          </button>
          <button className="v2-button v2-button--secondary" type="button" disabled>
            Unavailable
          </button>
        </div>
...
export function NavigationSpecimens() {
  ...
  const tabRefs = { preview: previewTabRef, code: codeTabRef }
    ...
    >
      <div className="v2-navigation-grid">
        ...
        <SpecimenCard title="Workflow steps" description="Connected stages show complete, current, and upcoming work.">
          <ol className="v2-workflow-steps" aria-label="Campaign workflow">
            <li className="is-complete"><span><Check aria-hidden="true" size={16} /></span><div><strong>Brief</strong><small>Complete</small></div></li>
            <li aria-current="step"><span>2</span><div><strong>Copy</strong><small>In progress</small></div></li>
            <li><span>3</span><div><strong>Assets</strong><small>Upcoming</small></div></li>
          </ol>
        </SpecimenCard>
      </div>
      ...
      <SpecimenCard title="Tabs and view controls" description="Pills mark tabs; segmented controls remain structural and compact.">
        <div className="v2-navigation-controls">
          <div>
            ...
            <div className="v2-pill-tabs" role="tablist" aria-label="Content view">
              {tabs.map((tab) => {
