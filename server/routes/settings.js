import { settingsPatchRequestSchema } from '../../shared/contracts.js'
import { parse, parseIfMatch, requireActor, setRevisionEtag } from './support.js'
...
export function registerSettingsRoutes(app, { resolveActor, workflowService }) {
  app.get('/api/v1/settings', async (request, reply) => {
    ...
    return setRevisionEtag(reply, settings)
  })
