...
describe('strict generation contracts', () => {
  ...
  test('requires provider, model, region, safe integer cost, usage, and safety on every result', () => {
    ...
    expect(generateCopyResultSchema.safeParse({ ...metadata, copies: [{ id: 'copy-1', headline: 'Learn now', body: 'Short lessons.', offer: '', cta: 'Start', visualPrompt: 'A Nordic desk.' }] }).success).toBe(true)
