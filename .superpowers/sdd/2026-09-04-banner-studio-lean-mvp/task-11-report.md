...
- Review round-three commit: `fix: bound generated image recovery` (this commit)
...
- Required PostgreSQL suite: `TEST_DATABASE_URL=postgresql:///banner_studio_test npm test -- --run server shared` — 25 files, 374 tests passed.
